...
export const iasEnvironments = {
  PRODUCTION: {
    ...
    iasPortalUrl:
      'https://authentification.quebec.ca/realms/sqin/protocol/openid-connect/auth?client_id=account-console&redirect_uri=https://authentification.quebec.ca/gestion-compte&state=a6d71a3a-338d-44c7-8b02-24b9ad04156b&response_mode=fragment&response_type=code&scope=openid&nonce=3eea77b7-2358-49e4-8078-44aff14eed45&code_challenge=J3kdWtd_BP2iyCM3doBtDf9-beSyU1uYEg_0Zl5gHuw&code_challenge_method=S256',
  },
  FORMATION: {
    iasAgentInviteUrl: Config.MEDIATOR_URL_DEV ?? '',
    iasPortalUrl:
      'https://auth-formation.it.authentification.si.gouv.qc.ca/realms/sqin/protocol/openid-connect/auth?client_id=account-console&redirect_uri=https://auth-formation.it.authentification.si.gouv.qc.ca/gestion-compte&state=a6d71a3a-338d-44c7-8b02-24b9ad04156b&response_mode=fragment&response_type=code&scope=openid&nonce=3eea77b7-2358-49e4-8078-44aff14eed45&code_challenge=J3kdWtd_BP2iyCM3doBtDf9-beSyU1uYEg_0Zl5gHuw&code_challenge_method=S256',
  },
  ACCEPTATION: {
    iasAgentInviteUrl: Config.MEDIATOR_URL_DEV ?? '',
    iasPortalUrl:
